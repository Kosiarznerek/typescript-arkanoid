 ...
 */
function WczytajGrafike(grafika: HTMLImageElement, sciezka: string): Promise<HTMLImageElement> {
 ...
 */
function ZaladujWszystkieGrafiki(callback: (value: HTMLImageElement[]) => void): void {
