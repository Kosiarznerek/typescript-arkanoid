 ...
 */
function ZaladujGrafike(img: HTMLImageElement, src: string): Promise<HTMLImageElement> {
 ...
 * @returns {Promise<HTMLImageElement>[]}
 */
function PrzeladujGrafiki(): Promise<HTMLImageElement>[] {
    return [
        //Cegiełki
        ...
        ...GRAFIKI.fiolki.B
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.B[index], `grafiki/fiolki/B/${index}.png`)
            ),

        //Fiolki.C
        ...GRAFIKI.fiolki.C
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.C[index], `grafiki/fiolki/C/${index}.png`)
            ),

        //Fiolki.D
        ...GRAFIKI.fiolki.D
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.D[index], `grafiki/fiolki/D/${index}.png`)
            ),

        //Fiolki.E
        ...GRAFIKI.fiolki.E
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.E[index], `grafiki/fiolki/E/${index}.png`)
            ),

        //Fiolki.L
        ...GRAFIKI.fiolki.L
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.L[index], `grafiki/fiolki/L/${index}.png`)
            ),

        //Fiolki.M
        ...GRAFIKI.fiolki.M
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.M[index], `grafiki/fiolki/M/${index}.png`)
            ),

        //Fiolki.R
        ...GRAFIKI.fiolki.R
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.R[index], `grafiki/fiolki/R/${index}.png`)
            ),

        //Fiolki.S
        ...GRAFIKI.fiolki.S
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.fiolki.S[index], `grafiki/fiolki/S/${index}.png`)
            ),

        //Paletka.rozwalenie
        ...GRAFIKI.paletka.rozwalenie
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.paletka.rozwalenie[index], `grafiki/paletka/rozwalenie/${index}.png`)
            ),

        //Paletka.wskrzeszenie
        ...GRAFIKI.paletka.wskrzeszenie
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.paletka.wskrzeszenie[index], `grafiki/paletka/wskrzeszenie/${index}.png`)
            ),
        ...
        ...GRAFIKI.przeciwnicy.kulki
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.kulki[index], `grafiki/przeciwnicy/kulki/${index}.png`)
            ),
        ...
        ...GRAFIKI.przeciwnicy.orbita
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.orbita[index], `grafiki/przeciwnicy/orbita/${index}.png`)
            ),

        //Przeciwnicy.stozek
        ...GRAFIKI.przeciwnicy.stozek
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.stozek[index], `grafiki/przeciwnicy/stozek/${index}.png`)
            ),

        //Przeciwnicy.szescian
        ...GRAFIKI.przeciwnicy.szescian
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.szescian[index], `grafiki/przeciwnicy/szescian/${index}.png`)
            ),

        //Przeciwnicy.kulki
        ...GRAFIKI.przeciwnicy.trojkat
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.trojkat[index], `grafiki/przeciwnicy/trojkat/${index}.png`)
            ),

        //Przeciwnicy.ziemia
        ...GRAFIKI.przeciwnicy.ziemia
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.przeciwnicy.ziemia[index], `grafiki/przeciwnicy/ziemia/${index}.png`)
            ),
        ...
        ...GRAFIKI.brama.otwarcie
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.brama.otwarcie[index], `grafiki/brama/otwarcie/${index}.png`)
            ),

        //Brama.zamkniecie
        ...GRAFIKI.brama.zamkniecie
            .map((value, index) =>
                ZaladujGrafike(GRAFIKI.brama.zamkniecie[index], `grafiki/brama/zamkniecie/${index}.png`)
            ),
